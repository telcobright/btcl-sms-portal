...
const useAboutPageData = (locale: string) => {
  const milestones: Milestone[] = [
    ...
    },
    {
      ...
      event: getLocalizedText(
        locale,
        'Communication Suite Expansion',
        'যোগাযোগ সমাধান সম্প্রসারণ'
      ),
      description: getLocalizedText(
        locale,
    ...
    },
    {
      ...
      event: getLocalizedText(
        locale,
        'Modern Platform Launch',
        'আধুনিক প্ল্যাটফর্ম চালু'
      ),
      description: getLocalizedText(
        locale,
  ...
  const awards: Award[] = [
    {
      ...
      organization: getLocalizedText(
        locale,
        'Bangladesh IT Awards',
        'বাংলাদেশ আইটি অ্যাওয়ার্ডস'
      ),
      icon: '🏆',
    },
    {
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center text-white">
          ...
          <p className="mx-auto mb-8 max-w-3xl text-xl text-white">
            {getLocalizedText(
              locale,
              "Leading Bangladesh's telecommunications infrastructure, delivering corporate-grade communication solutions including Alaap Cloud Contact Center, Alaap Cloud IP PBX, Alaap Cloud Voice Broadcasting Service and Bulk SMS Service",
              'বাংলাদেশের টেলিযোগাযোগ অবকাঠামোর নেতৃত্ব দিচ্ছি, Alaap Cloud Contact Center, Alaap Cloud IP PBX, Alaap Cloud Voice Broadcasting Service এবং Bulk SMS Service সহ কর্পোরেট-গ্রেড যোগাযোগ সমাধান প্রদান করছি।'
            )}
          </p>
          ...
          <div className="mt-8 flex justify-center">
            ...
            >
              ...
              <span>
                {getLocalizedText(
                  locale,
                  'Visit Official BTCL Website',
                  'অফিসিয়াল বিটিসিএল ওয়েবসাইট দেখুন'
                )}
              </span>
              <svg
                className="h-4 w-4"
        ...
        return (
          ...
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
              d="M3 21h18M3 10l9-7 9 7M5 21V10m4 11V10m6 11V10m4 11V10"
            />
          </svg>
        );
      case 'star':
        ...
        return (
          ...
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
              d="M12 1v22M17 5H9.5a3.5 3.5 0 100 7H14a3.5 3.5 0 110 7H6"
            />
          </svg>
        );
      default:
...
function TimelineItem({
  ...
  return (
    <div
      className={`flex items-center gap-8 md:gap-16 ${isReversed ? 'md:flex-row-reverse' : 'md:flex-row'}`}
    >
      {/* Content */}
        ...
        return (
          ...
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
              d="M8 11V8a2 2 0 014 0v3"
            />
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
              d="M16 11V9a2 2 0 014 0v6c0 3-2 5-5 5h-3l-4-3-3-1c-1-.5-1.5-1.5-1-2.5l1-2c.5-1 1.5-1.5 2.5-1L8 11h8z"
            />
          </svg>
        );
      case 'innovation':
        return (
          ...
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
              d="M14.5 3l-1 4-4 1 5 5-1 4 4-1 5 5-4 1-1 4-5-5-4 1 1-4-5-5 4-1 1-4 5 5z"
            />
          </svg>
        );
      case 'accessibility':
