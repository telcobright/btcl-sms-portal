...
// ═══════════════════════════════════════════════════════════════════════════
// Proposed admin dashboard — draft at /admin/temp-dashboard.
//
// Same figures as /admin, same fallbacks, same links, same subscriber list:
// this is a new arrangement of the page, not a new set of numbers. Anything
// missing here would be a regression, so the loader below is the live page's,
// carried over whole — including the three-step climb-down for per-service
// package counts and the progressive document review.
//
// What changes is the reading order. The live page is a strip of six white
// cards, four service cards and three equal columns, so nothing is louder than
// anything else. Here the standing totals sit in the header band where they
// belong, the four services keep their colours but carry their share of
// revenue, and what is WAITING — documents to review — gets the widest column.
//
// Not linked from the sidebar; deleting this folder removes it.
// ═══════════════════════════════════════════════════════════════════════════
