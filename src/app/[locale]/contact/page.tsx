...
const useContactData = (locale: string) => {
  ...
  const faqs: FAQ[] = [
    ...
    },
    {
      ...
      answer: getLocalizedText(
        locale,
        '• Package migration policy is given in the following link:\nhttps://www.alaapcloud.gov.bd/en/package-migration-policy',
