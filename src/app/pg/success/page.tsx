    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden">
          {/* Header */}
          <div
            className={`px-6 py-8 text-center ${isDowngrade ? 'bg-gradient-to-r from-amber-500 to-amber-600' : 'bg-gradient-to-r from-[#0D529E] to-[#1F3C71]'}`}
          >
            <div className="mx-auto w-20 h-20 bg-white rounded-full flex items-center justify-center mb-4 shadow-lg">
              <svg
                className={`w-12 h-12 ${isDowngrade ? 'text-amber-500' : 'text-[#0D529E]'}`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
                ...
                <div className="flex flex-col items-center text-center gap-3">
                  ...
                  <div className="w-full mt-2 p-3 bg-amber-50 rounded-lg border border-amber-200 text-left">
                    <p className="text-xs text-amber-800">
                      <strong>Note:</strong> Your username and password are
                      included in the email. Please change your password after
      ...
      <footer className="bg-white border-t border-gray-200 py-4">
        <div className="max-w-7xl mx-auto px-4 text-center text-sm text-gray-500">
          &copy; {new Date().getFullYear()} Bangladesh Telecommunications
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="max-w-md w-full">
          <div className="bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden">
            <div className="bg-gradient-to-r from-[#0D529E] to-[#1F3C71] px-6 py-8 text-center">
              <div className="mx-auto w-20 h-20 bg-white rounded-full flex items-center justify-center mb-4">
                <svg
                  className="w-12 h-12 text-[#0D529E]"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <div className="space-y-4">
                ...
                {amount && (
                  <div className="flex justify-between items-center py-3 border-b border-gray-100">
                    ...
                    <span className="font-semibold text-[#0D529E]">
                      BDT {amount}
                    </span>
                  </div>
                )}
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            ...
            <a
              href="mailto:support@btcl.com.bd"
              className="text-[#0D529E] hover:underline"
            >
              support@btcl.com.bd
            </a>
          </p>
