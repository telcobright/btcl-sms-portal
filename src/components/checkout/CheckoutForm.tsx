...
export default function CheckoutForm({
  ...
  return (
    <form className="space-y-8 text-btcl-gray-800" onSubmit={(e) => e.preventDefault()}>
      ...
      {customerPrePaid === 2 && (
        <fieldset className="space-y-4">
          <div className="bg-btcl-primaryLight/10 border border-btcl-primaryLight/30 rounded-lg p-4">
            <div className="flex items-center">
              <svg className="w-5 h-5 text-btcl-primary mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <span className="text-btcl-primaryDark font-medium">Postpaid Account</span>
            </div>
            <p className="text-btcl-primaryDark text-sm mt-2">
