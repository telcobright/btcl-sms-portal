...
export function Footer() {
  ...
  const IconEmail = () => (
    <svg
      className="h-4 w-4 text-btcl-primary"
      fill="none"
      stroke="currentColor"
      strokeWidth={1.8}
      viewBox="0 0 24 24"
  ...
  const IconHeadset = () => (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M3 14v-2a9 9 0 0118 0v2M3 14a2 2 0 002 2h1v-6H5a2 2 0 00-2 2v2zm18 0a2 2 0 01-2 2h-1v-6h1a2 2 0 012 2v2z"
      />
    </svg>
  );

  const sectionTitle =
    'mb-5 text-xs font-semibold uppercase tracking-wider text-btcl-primary';
  const linkBase =
    'text-sm text-gray-600 transition-colors duration-200 hover:text-btcl-primary';
        ...
        <div className="grid grid-cols-1 gap-10 py-16 md:grid-cols-2 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3">
              <li>
                <Link href={`/${locale}`} className={linkBase}>
                  {locale === 'en' ? 'Home' : 'হোম'}
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href={`/${locale}/services`} className={linkBase}>
                  {locale === 'en' ? 'Services' : 'সেবাসমূহ'}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/pricing`} className={linkBase}>
                  {locale === 'en' ? 'Pricing' : 'প্রাইসিং'}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/contact`} className={linkBase}>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link
                  ...
                  className={linkBase}
                >
                  Alaap Cloud Voice Broadcasting
                </Link>
              </li>
              <li>
                <Link
          ...
          <div className="lg:col-span-3">
            ...
            <div className="space-y-4">
              ...
              <div className="border-t border-gray-100 pt-4">
                <p className="mb-2 text-sm font-semibold text-gray-900">
                  {locale === 'en'
                    ? 'DGM Switch Moghbazar Office'
                    : 'ডিজিএম সুইচ মগবাজার অফিস'}
                </p>
                <div className="flex items-start gap-2.5">
                  <div className="mt-0.5 flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-md bg-btcl-primaryLight/10">
                    <IconPhone />
                  ...
                  <div className="flex flex-wrap gap-x-2 gap-y-1 text-sm text-gray-600">
                    <a
                      ...
                      className="hover:text-btcl-primary"
                    >
                      +880258311616
                    </a>
                    <a
                ...
                <div className="mt-2 flex items-center gap-2.5">
                  ...
                  <div className="text-sm text-gray-600">
                    <span>
                      {locale === 'en' ? 'Call Center:' : 'কল সেন্টার:'}
                    </span>{' '}
                    <a
                      href="tel:16402"
